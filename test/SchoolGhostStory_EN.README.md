...
for download convenience ONLY. Not a bundled map: excluded from
maps/, the builds freshness guard, preflight, and all toolkit doctrine.
Do not treat as a reference source; do not add further third-party maps
here without explicit owner direction.

Translation working files (dictionaries, extraction, original archive)
live in the session scratchpad only, per Legal.
