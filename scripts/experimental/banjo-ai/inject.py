...
REQUIRED = [
    ...
    r'(?<![A-Za-z0-9_])rect gg_rct_Start_2\b',
    r'(?<![A-Za-z0-9_])trigger array s__Event_e\b',
    r'(?<![A-Za-z0-9_])integer EVENT_FIELD_CHOOSE\b',
    r'(?<![A-Za-z0-9_])integer Players___playerCountHuman\b',
    r'function Players___initPlayer takes player',
    r'function ArrangeStartPositions takes nothing',
