...
// FourCC; the first char is the tileset). Covers every suffix in the WE
// default tile palettes of all 18 tilesets (see the per-tileset FourCC
// tables in docs/FORMATS.md); the fallback below still catches anything
// custom/unknown.
const TILE_COLORS = {
  dirt: [114, 84, 55], drt: [114, 84, 55],
  dro: [126, 94, 60], // rough dirt
  drd: [88, 62, 42], // dark/rough dirt (Ashenvale/Felwood/Northrend)
  drh: [122, 90, 58], // rough dirt (Barrens)
  drr: [125, 98, 70], // pebbles (Barrens) / rough dirt (Village)
  dtr: [126, 94, 60], // rough dirt (city tilesets) / light dirt (Outland/Black Citadel)
  drg: [96, 104, 48], // grassy dirt
  rok: [112, 112, 112], // rock
  rck: [112, 112, 112], // rock (Ashenvale/Felwood/Northrend/Village)
  flr: [128, 116, 100], // rock (Barrens)
  grs: [52, 110, 42], // grass
  grd: [38, 88, 34], // dark/lumpy grass
  grr: [110, 120, 52], // grass (Barrens)
  grt: [44, 96, 38], // thick grass (Village)
  gsb: [60, 110, 45], // grass (city tilesets)
  hdg: [50, 95, 40], // grass trim/hedge (city tilesets)
  snw: [225, 230, 238], // snow
  snr: [200, 205, 212], // rocky/pocky snow (Northrend)
  sng: [190, 205, 190], // grassy snow (Lordaeron Winter)
  ice: [170, 205, 225],
  dki: [120, 160, 185], // dark ice (Icecrown)
  san: [205, 185, 130], // sand
  dsr: [196, 168, 116], // desert (Barrens)
  dsd: [160, 130, 88], // dark desert (Barrens)
  sqd: [205, 185, 130], // square tiles
  sqt: [130, 125, 120], // square tiles (Black Citadel)
  dkt: [55, 50, 55], // dark tiles (Black Citadel)
  lvc: [60, 45, 45], // lava cracks / ice chunks (Underground)
  lav: [180, 60, 20], // lava / ice (Underground)
  vin: [70, 95, 45], // vines
  lea: [70, 100, 45], // leaves
  lvd: [70, 100, 45], // leaves (Ashenvale)
  lvg: [70, 100, 45], // leaves (Felwood)
  pos: [90, 140, 60], // poison (Felwood)
  crp: [150, 120, 60], // crops (Village)
  cbp: [130, 125, 115], // cobble path (Village)
  stp: [150, 145, 135], // stone path (Village)
  brk: [130, 105, 85], // brick (Dungeon/Underground)
  bks: [140, 120, 100], // small bricks (Sunken Ruins)
  bkl: [150, 130, 110], // large bricks (Sunken Ruins)
  smb: [120, 110, 100], // small bricks (Black Citadel) / rough dirt (Outland)
  lgb: [125, 115, 105], // large bricks (Black Citadel) / flat stones (Outland)
  fst: [135, 125, 110], // flat stones (Black Citadel) / cracked dirt (Outland)
  fsl: [150, 140, 125], // light flat stones (Outland/Black Citadel)
  blm: [45, 45, 50], // black marble (city tilesets)
  wmb: [200, 200, 205], // white marble (city tilesets)
  btl: [140, 110, 90], // brick tiles (city tilesets)
  rtl: [155, 150, 140], // round tiles (city tilesets)
  til: [155, 150, 140], // round tiles (Sunken Ruins)
  rds: [140, 80, 70], // red stones (Dungeon/Underground)
  dkr: [70, 65, 60], // dark rocks (Dungeon/Underground)
  bkb: [40, 40, 45], // black bricks (Icecrown)
  rbk: [90, 80, 110], // rune bricks (Icecrown)
  tbk: [120, 110, 125], // tiled bricks (Icecrown)
  bsq: [50, 50, 55], // black squares (Icecrown)
  aby: [25, 20, 35], // abyss (Outland)
};
