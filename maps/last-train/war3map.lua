...
PROP_KINDS = {
  ...
  -- Sol round-4 interior re-art (2026-08-08): flat-furniture classes for
  -- the tower pockets. Each keeps its re-pointed placement's ORIGINAL
  -- loot kind, so the seeded draw sequences are byte-stable (bed was a
  -- bench slot, wardrobe a locker, kitchen a table, TV a desk, altar a
  -- dumpster) — cosmetic-only by construction.
  [UNIT_FLAT_BED_FRAME] = "bench",
  [UNIT_FLAT_WARDROBE] = "locker",
  [UNIT_KITCHEN_UNIT] = "table",
  [UNIT_TV_CONSOLE] = "desk",
  [UNIT_FAMILY_ALTAR] = "dumpster",
}
...
TOWER = {
  { key = "6f", cx = -3400, name = "the sixth-floor corridor",
    lift = { x = -3760, y = -5040 },         -- the dead lift bank sparks
                                             --   (flush on the N wall since
                                             --   the Sol round-4 lift doodad
                                             --   replaced the pillar stand-in)
...
function ShowCreditsCmd(pid)
  ...
  Tell(pid, "|cffaaddffCommissioned models:|r Sol (GPT 5.6 Codex fleet) -- four batches: round 1 (2026-08-07): HDB point tower, hawker centre, MRT platform canopies, bus stop shelters, street lamps, the monsoon drain, overhead bridges, kopitiam seating; round 2: the Broodmother, the kampong lair set (flesh pods, bone mounds, house shells), fare gates, platform screen doors, void-deck pillars, mailbox walls, bike racks, taxis, food carts; round 3, the Singapore identity set: the Last Train itself, the six-tower CBD skyline, the MRT entrance and line signs, laundry racks, linkway canopies, viaduct bents, platform clocks; round 4 (2026-08-08), the Block 6A interior set: corridor walls and corners, flat doors, the dead lift bank, stairwell flights, tube lights, the flat furniture (bed, wardrobe, kitchen, TV console, family altar), covered bodies, and the spike wire and watchfire you build.")
