...
function ShowCreditsCmd(pid)
  ...
  Tell(pid, "|cffaaddffCommissioned ambience models:|r Sol (GPT 5.6 Codex fleet) -- the 2026-08-07 batch: HDB point tower, hawker centre, MRT platform canopies, bus stop shelters, street lamps, the monsoon drain, overhead bridges, kopitiam seating.")
  ...
  Tell(pid, "|cff888888Everything else (train, platform, viaduct, HDB blocks, substations, icons, terrain) is generated by this map's committed asset scripts. Built headlessly with wc3-map-toolkit.|r")
end
...
function ShowCredits()
  ...
  QuestSetDescription(q, "Last Train from Yio Chu Kang -- a map by Serendipity (wc3-map-toolkit)."
    ...
    .. " Commissioned ambience models: Sol (GPT 5.6 Codex fleet), 2026-08-07 batch."
