// mdl-lib.mjs — shared MDL-authoring helper for the Coinstead model
// generators (generate-models.mjs).
//
...
\tGeosetAnimId ${i},
  ...
  const mdl = `// ${name} — generated by maps/coinstead/assets (wc3-map-toolkit)
Version {
\tFormatVersion 800,
}
Model "${name}" {
